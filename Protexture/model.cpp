...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	heightData = LoadHeightMap("Islands.bmp");
	terrainTexture = LoadTexture("TerrainTex.bmp");
	/*terrainTexture = LoadTexture("data\\grass.bmp");
	heightData = LoadHeightMap("DU icon.bmp");
*/
...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	MyCamera.Render();
	//MyCamera.Position.y = (float)((int)(MyCamera.Position.x + TerrainSize / 2.0), (int)(MyCamera.Position.z + TerrainSize / 2.0))*scaley + 1;
	...
	tree.Materials[0].tex = m1;
	tree.Materials[1].tex = m2;
